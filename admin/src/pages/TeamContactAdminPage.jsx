...
import { addTeamContact, getTeamContacts } from '../Api/teamContactApi';
...
const TeamContactAdminPage = () => {
  ...
  return (
    <div className="main-container py-8">
      <div className="bg-gradient-to-r from-blue-400 to-indigo-800 rounded-xl shadow-lg p-8 mb-8 flex flex-col items-center">
        <h2 className="text-3xl text-white font-bold mb-2 tracking-wide">Team Contact Management</h2>
        <p className="text-white/80 mb-4">Add and manage your team contacts easily.</p>
        <div className="w-full max-w-lg">
          <TeamContactForm onSubmit={handleAddContact} />
        </div>
      </div>
