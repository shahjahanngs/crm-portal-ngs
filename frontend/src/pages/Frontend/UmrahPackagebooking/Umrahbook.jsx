                    ...
                    >
                      ...
                      <div className="mt-3">
                        ...
                        <div className="flex items-center gap-3">
                          <label className="flex items-center gap-2 cursor-pointer px-3 py-2 bg-gray-50 border border-dashed border-gray-300 rounded-lg hover:bg-gray-100 text-xs text-gray-600 transition-colors">
