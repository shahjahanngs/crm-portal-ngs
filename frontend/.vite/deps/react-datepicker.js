...
var CalendarContainer = function(_a2) {
  ...
  return import_react3.default.createElement("div", { className, "aria-label": ariaLabel, role: inline3 ? void 0 : "dialog", "aria-modal": inline3 ? void 0 : "true", translate: "no" }, children);
};
      ...
      _this.header = function(date, customDayNameCount) {
        ...
        return dayNames.concat([0, 1, 2, 3, 4, 5, 6].map(function(offset3) {
          ...
          if (_this.props.renderCustomDayName) {
            ...
            return import_react3.default.createElement("div", { key: offset3, role: "columnheader", className: clsx("react-datepicker__day-name", weekDayClassName, disabled ? "react-datepicker__day-name--disabled" : "") }, customContent);
          }
          return import_react3.default.createElement(
            "div",
